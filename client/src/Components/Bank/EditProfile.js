                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: "1rem" }}>
                                    ...
                                    <div style={{ gridColumn: "1", gridRow: "1/2" }}>
                                        ...
                                        <input
                                            ...
                                            disabled
                                            value={"Longi: "+longitude.toString()}
                                            onChange={(e) => setLongitude(e.target.value)}
                                            required
                                        />
                                        <button type="button" disabled={edit} className="bg-purple text-center text-white-900 cursor-pointer rounded-lg mt-4 px-4 py-2" onClick={() => fetchGeo()}>
                                            Update Geocode
                                        </button>
                                    </div>
                                </div>
